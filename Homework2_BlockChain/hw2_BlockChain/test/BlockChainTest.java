...
//        assertThat(blockChain.getMaxHeightUTXOPool().getAllUTXO().size(), equalTo(22));
//        assertThat(blockChain.getMaxHeightBlock().getHash(), equalTo(block[20].getHash()));
//        assertThat(blockChain.getMaxHeightBlock().getCoinbase(), equalTo(new Transaction(25, keyPair[20].getPublic())));
//        assertThat(blockChain.getTransactionPool().getTransactions().size(), equalTo(0));
